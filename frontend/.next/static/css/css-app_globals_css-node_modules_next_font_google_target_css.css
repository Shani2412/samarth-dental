...
.btn-primary {
  ...
  --tw-bg-opacity: 1;
  background-color: rgb(11 110 104 / var(--tw-bg-opacity, 1));
  padding-left: 2rem;
  padding-right: 2rem;
  padding-top: 0.75rem;
  ...
  --tw-shadow: 0 4px 16px rgba(11,110,104,0.3);
...
.btn-primary:hover {
  ...
  --tw-bg-opacity: 1;
  background-color: rgb(9 79 74 / var(--tw-bg-opacity, 1));
  --tw-shadow: 0 8px 24px rgba(11,110,104,0.35);
...
.btn-outline {
  ...
  border-width: 2px;
  --tw-border-opacity: 1;
  border-color: rgb(11 110 104 / var(--tw-border-opacity, 1));
  padding-left: 2rem;
  padding-right: 2rem;
  padding-top: 0.75rem;
  padding-bottom: 0.75rem;
  ...
  font-weight: 500;
  --tw-text-opacity: 1;
  color: rgb(11 110 104 / var(--tw-text-opacity, 1));
  transition-property: all;
  transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);
  transition-duration: 150ms;
}
...
.input-field:focus {
  ...
  --tw-ring-color: rgb(11 110 104 / 0.1);
}
.card {
  overflow: hidden;
  ...
  --tw-bg-opacity: 1;
  background-color: rgb(255 255 255 / var(--tw-bg-opacity, 1));
  --tw-shadow: 0 2px 12px rgba(0,0,0,0.07);
...
.border-teal\/20 {
  border-color: rgb(11 110 104 / 0.2);
}
.border-transparent {
...
.bg-gold-light {
  --tw-bg-opacity: 1;
  background-color: rgb(251 245 232 / var(--tw-bg-opacity, 1));
}
.bg-gold\/5 {
...
.bg-teal\/5 {
  background-color: rgb(11 110 104 / 0.05);
}
.bg-teal\/80 {
  background-color: rgb(11 110 104 / 0.8);
}
.bg-white {
  --tw-bg-opacity: 1;
  background-color: rgb(255 255 255 / var(--tw-bg-opacity, 1));
...
.from-teal {
  --tw-gradient-from: #0B6E68 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(11 110 104 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-teal-light {
  --tw-gradient-from: #E6F5F4 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(230 245 244 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.via-white {
...
.to-teal-mid {
  --tw-gradient-to: #1D9E8F var(--tw-gradient-to-position);
}
.to-white {
...
.text-teal-mid {
  --tw-text-opacity: 1;
  color: rgb(29 158 143 / var(--tw-text-opacity, 1));
}
.text-white {
  --tw-text-opacity: 1;
  color: rgb(255 255 255 / var(--tw-text-opacity, 1));
...
.shadow-teal\/20 {
  --tw-shadow-color: rgb(11 110 104 / 0.2);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-teal\/30 {
  --tw-shadow-color: rgb(11 110 104 / 0.3);
  --tw-shadow: var(--tw-shadow-colored);
}
.outline-none {
  outline: 2px solid transparent;
...
.hover\:bg-teal\/90:hover {
  background-color: rgb(11 110 104 / 0.9);
}
