...
import { Home, Calendar, ClipboardList, Star, LogOut, Globe, History, Menu, X } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/dashboard/history',      icon: History,       label: 'My Dental History' },
];
      ...
      <main className="flex-1 md:ml-60 bg-gray-50 min-h-screen">
        ...
        <div className="md:hidden flex items-center justify-between px-4 py-3 bg-teal sticky top-0 z-10 shadow-sm">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-white font-bold text-sm">Samarth Dental</span>
          </div>
